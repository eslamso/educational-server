...
userSchema.methods.SignAccessToken = function () {
    return jsonwebtoken_1.default.sign({ id: this._id, deviceId: this.deviceId }, process.env.ACCESS_TOKEN || "", {
        expiresIn: "5m",
    });
};
// sign refresh token
userSchema.methods.SignRefreshToken = function () {
    return jsonwebtoken_1.default.sign({ id: this._id, deviceId: this.deviceId }, process.env.REFRESH_TOKEN || "", {
        expiresIn: "300d",
    });
};
// compare password
